...
export default function ToReceiveOutForDelivery({
    toReceiveOutForDeliveryData,
}) {
    return (
        <>
            hello
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {toReceiveOutForDeliveryData.length == 0 ? (
                    ...
                    toReceiveOutForDeliveryData.map((item) => (
                        <div
                            key={item.id}
                        ...
                        >
                            ...
                            <button
                                disabled={true}
                                className="w-full bg-blue-200  text-blue-700 p-2 rounded-lg"
                            >
                                Parcel is out for delivery now
                            </button>
                        </div>
                    ))
                )}
