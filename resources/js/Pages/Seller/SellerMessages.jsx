...
export default function SellerMessages() {
    ...
    const handleDeleteConvo = (id) => {
        patch(route('seller.delete.convo', {
            convo_id: id
        }));
        ...
        <SellerMessageLayout >
            ...
            <div className="flex flex-grow w-full h-full bg-slate-200">
                <div className="border-r min-w-[30%] bg-slate-100 border-slate-200">
                    ...
                    {/* Convo list */}
                    <div className={`p-1.5 max-h-[calc(100vh-14.800rem)] min-h-[calc(100vh-13.210rem)] space-y-1 ${conversations && conversations.length >= 2 ? 'overflow-y-auto' : ''} mb-9`}>
